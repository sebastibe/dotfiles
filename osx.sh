...
sudo scutil --set ComputerName "SebBook Pro"
sudo scutil --set HostName "SebBook Pro"
sudo scutil --set LocalHostName "SebBook-Pro"
sudo defaults write /Library/Preferences/SystemConfiguration/com.apple.smb.server NetBIOSName -string "SebBook-Pro"
